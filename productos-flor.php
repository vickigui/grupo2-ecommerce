  ...
  <div class="container">
  	  	<div class="row">
  	  		<div class="col-sm-12">
  	  			...
  	  			<div align="center">
  				    <button class="btn btn-success active filter-button" data-filter="todo">Todo</button>
  				    <button class="btn btn-success filter-button" data-filter="frutas">Frutas</button>
  				    <button class="btn btn-success filter-button" data-filter="verduras">Verduras</button>
  				    <button class="btn btn-success filter-button" data-filter="almacen">Almacen Orgánico</button>
