...
<div class="user"><a class="nav-link" data-toggle="tooltip" title="Iniciá sesión"  href="registro.php"><i class="fas fa-user"></i></a></div>



     <div class="carrito"><a class="nav-link" data-toggle="tooltip" title="Mi Carrito"  href="miCarrito.php"><i class="fas fa-shopping-cart"></i></a></div>
   </div>
 </nav>
</header>
